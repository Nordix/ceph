...
class TestFetchK8sItems(object):
    ...
    def test_fetch_spawns_no_watcher_thread(self):
        import rook.rook_cluster as rook_cluster
        ...
        # connection
        with patch.object(rook_cluster.threading, 'Thread',
                          side_effect=AssertionError('fetch_k8s_items must not spawn threads')):
